...
namespace DSPA_MeAudVis.Web.Controllers
{
    public class LoanDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Observations")] LoanDetail loanDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Observations")] LoanDetail loanDetail)
        {
            if (id != loanDetail.Id)
            {
                return NotFound();
